...
int OriGen(int a[][MAX], int m, int n) { //Read vi sinh vat ban dau C:/Users/DELL/Desktop/work.dat
	ifstream myFile;
	myFile.open("C:/Users/DELL/Desktop/work.dat");
	if (!myFile) {
...
int main() {
	...
	OriGen(a, m, n);
	cout << endl << "Read successfully from the file: C:/Users/DELL/Desktop/work.dat" << endl << endl;
	cout << endl << "Original Generation: " << endl << endl;
	Output(a, m, n);

	//Ghi File work.out
	ofstream wFile;
	wFile.open("C:/Users/DELL/Desktop/work.out");
	...
	cout << endl << endl << "Write successfully to the file C:/Users/DELL/Desktop/work.out" << endl << endl;
